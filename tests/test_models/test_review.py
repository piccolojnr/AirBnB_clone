...
class TestReviewDocs(unittest.TestCase):
    """Tests to check the documentation and style of the Review class"""
    @classmethod
    def setUpClass(cls):
...
class TestReview(unittest.TestCase):
    ...
    def test_to_dict_creates_dict(self):
        """test to_dict method that creates a dictionary with proper attrs"""
        re = Review()
        new_d = re.to_dict()
        self.assertEqual(type(new_d), dict)
        for attr in re.__dict__:
    ...
    def test_to_dict_values(self):
        ...
        self.assertEqual(new_d["created_at"], re.created_at.strftime(t_format))
        self.assertEqual(new_d["updated_at"], re.updated_at.strftime(t_format))
