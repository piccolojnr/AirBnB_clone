...
class test_place_instantiation(unittest.TestCase):
    ...
    def test_city_id_is_public_class_attributes(self):
        pl = Place()
    ...
    def test_two_place_different_created_at(self):
        pl1 = Place()
        sleep(0.05)
        pl2 = Place()
        self.assertLess(pl1.created_at, pl2.created_at)

    def test_two_place_different_updated_at(self):
        pl1 = Place()
        sleep(0.05)
        pl2 = Place()
